...
class TVLQRController:
    ...
    """
    def __init__(self, data_dict, urdf_path, force_limit=6):
        """
        Parameters
        ----------
        ...
        self.R = np.eye(1)
        self.Qf = np.diag([100, 100, 100, 100])
        self.options.u0 = u0
        self.options.x0 = x0
    ...
    def set_goal(self, x):
        ...
        self.options.Qf = self. Qf #np.diag([250, 1500, 0, 0])
    ...
    def get_control_output(self, mea_time, mea_cart_pos, mea_pend_pos, mea_cart_vel, mea_pend_vel, k_loop):
        """

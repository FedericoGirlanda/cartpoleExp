...
def discrete_dynamics_rungekutta(sys, x, u, dt):
    k1 = sys.continuous_dynamics2(x, u)
    k2 = sys.continuous_dynamics2(x+0.5*dt*k1, u)
    k3 = sys.continuous_dynamics2(x+0.5*dt*k2, u)
    k4 = sys.continuous_dynamics2(x+dt*k3, u)
